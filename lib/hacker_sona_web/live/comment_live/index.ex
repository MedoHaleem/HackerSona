defmodule HackerSonaWeb.CommentLive.Index do
  ...
  def mount(_params, _session, socket) do
    {:ok, stream(socket, :comments, Content.list_comments())}
  end
  ...
  @impl true
  def handle_info({HackerSonaWeb.CommentLive.FormComponent, {:saved, comment}}, socket) do
  ...
  def handle_event("delete", %{"id" => id}, socket) do
    ...
    {:ok, _} = Content.delete_comment(comment)
